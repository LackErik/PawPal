...
describe('Button Test', () => {
  ...
  beforeAll(async () => {
    ...
    await page.goto('http://localhost:80'); // Hier die URL der HTML-Seite einfügen
  }, 30000);
  ...
  it('sollte den Klick auf den Button simulieren und zur ersten Frage weiterleiten', async () => {
    ...
    expect(url).toBe('http://localhost/question1'); // Hier die erwartete Weiterleitungs-URL einfügen
  });
  ...
  it('sollte die Button-Bar überprüfen und zur nächsten Frage weiterleiten', async () => {
    ...
    expect(newURL).toBe('http://localhost/question2');
  });
  ...
  it('sollte die Auswahl der Bilder überprüfen und zur nächsten Frage weiterleiten', async () => {
    ...
    await page.waitForNavigation();
    const newURL = page.url();
    expect(newURL).toBe('http://localhost/question3');
  });
  ...
  it('sollte die Button-Bar überprüfen und zur nächsten Frage weiterleiten', async () => {
    ...
    await page.waitForNavigation();
    const newURL = page.url();
    expect(newURL).toBe('http://localhost/question4');
  });
  ...
  it('sollte die Bilder in Frage 4 überprüfen und zur nächsten Frage weiterleiten', async () => {
    ...
    await page.waitForNavigation();
    const newURL = page.url();
    expect(newURL).toBe('http://localhost/question5');
  });
  ...
  it('sollte die Button-Bar in Frage 5 überprüfen und zur nächsten Frage weiterleiten', async () => {
    ...
    await page.waitForNavigation();
    const newURL = page.url();
    expect(newURL).toBe('http://localhost/question6');
  });
  ...
  it('sollte die Button-Bar in Frage 6 überprüfen und zur nächsten Frage weiterleiten', async () => {
    ...
    await page.waitForNavigation();
    const newURL = page.url();
    expect(newURL).toBe('http://localhost/question7');
  });
  ...
  it('sollte die Button-Bar in Frage 7 überprüfen und zum Ergebnis weiterleiten', async () => {
    ...
    await page.waitForNavigation();
    const newURL = page.url();
    expect(newURL).toBe('http://localhost/result');
  });

  it('sollte den "Go Back"-Button auf jeder Seite überprüfen', async () => {
    // Seite 1
    await page.goto('http://localhost/question2');
    await page.waitForSelector('#back_btn');
    const backButton1 = await page.$('#back_btn');
    await backButton1.click();
    await page.waitForNavigation();
    expect(page.url()).toBe('http://localhost/question1');
  
    // Seite 2
    await page.goto('http://localhost/question3');
    await page.waitForSelector('#back_btn');
    const backButton2 = await page.$('#back_btn');
    await backButton2.click();
    await page.waitForNavigation();
    expect(page.url()).toBe('http://localhost/question2');
  
    // Seite 3
    await page.goto('http://localhost/question4');
    await page.waitForSelector('#back_btn');
    const backButton3 = await page.$('#back_btn');
    await backButton3.click();
    await page.waitForNavigation();
    expect(page.url()).toBe('http://localhost/question3');
  
    // Seite 4
    await page.goto('http://localhost/question5');
    await page.waitForSelector('#back_btn');
    const backButton4 = await page.$('#back_btn');
    await backButton4.click();
    await page.waitForNavigation();
    expect(page.url()).toBe('http://localhost/question4');
  
    // Seite 5
    await page.goto('http://localhost/question6');
    await page.waitForSelector('#back_btn');
    const backButton5 = await page.$('#back_btn');
    await backButton5.click();
    await page.waitForNavigation();
    expect(page.url()).toBe('http://localhost/question5');
  
    // Seite 6
    await page.goto('http://localhost/question7');
    await page.waitForSelector('#back_btn');
    const backButton6 = await page.$('#back_btn');
    await backButton6.click();
    await page.waitForNavigation();
    expect(page.url()).toBe('http://localhost/question6');
  });
  ...
  it('sollte den Impressums Button Testen und zum Impressum weiterleiten', async () => {
    ...
    const url = await page.url();
    expect(url).toBe('http://localhost/impressum'); // Hier die erwartete Weiterleitungs-URL zur Impressum-Seite einfügen
  });
});
