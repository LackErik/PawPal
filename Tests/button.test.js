...
describe('Button Test', () => {
  ...
  beforeAll(async () => {
    ...
    await page.goto('http://localhost:3005'); // Hier die URL der HTML-Seite einfügen
  });
  ...
  it('should simulate a click event on the button and redirect to the expected location', async () => {
    ...
    expect(url).toBe('http://localhost:3005/question'); // Hier die erwartete Weiterleitungs-URL einfügen
  });
});